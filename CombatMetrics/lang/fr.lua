...
SafeAddString(SI_COMBAT_METRICS_SHOWIDS, "Afficher les IDs", 1)
SafeAddString(SI_COMBAT_METRICS_HIDEIDS, "Cacher les IDs", 1)
...
SafeAddString(SI_COMBAT_METRICS_AVE, "Moy", 1)
SafeAddString(SI_COMBAT_METRICS_MAX, "Max", 1)
...
SafeAddString(SI_COMBAT_METRICS_STATS_MAGICKA_FORMAT3, "%.1f %%", 1)
...
SafeAddString(SI_COMBAT_METRICS_STATS_MAGICKA_FORMAT6, "%.1f %%", 1)
...
SafeAddString(SI_COMBAT_METRICS_STATS_STAMINA_FORMAT3, "%.1f %%", 1)
...
SafeAddString(SI_COMBAT_METRICS_STATS_STAMINA_FORMAT6, "%.1f %%", 1)
...
SafeAddString(SI_COMBAT_METRICS_STATS_HEALTH_FORMAT4, "%.1f %%", 1)
...
SafeAddString(SI_COMBAT_METRICS_PAGE, "Page <<1>>", 1)
...
SafeAddString(SI_COMBAT_METRICS_MENU_SHOW_BG_NAME, "Affiche l'Arrière-Plan", 1)
SafeAddString(SI_COMBAT_METRICS_MENU_SHOW_BG_TOOLTIP, "Afficher l'arrière-plan de la fenêtre de rapport en direct.", 1)
