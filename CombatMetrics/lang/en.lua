...
-- Fonts
	...
	SI_COMBAT_METRICS_STD_FONT = "EsoUI/Common/Fonts/Univers57.otf",
	SI_COMBAT_METRICS_BOLD_FONT = "EsoUI/Common/Fonts/Univers67.otf",
...
-- Settings Menu
	...
	SI_COMBAT_METRICS_MENU_LM_TOOLTIP = "When in light mode, combat metrics will only calculate the DPS/HPS in the live report window. No statistics will be calculated and the big report window will be disabled",
	...
	SI_COMBAT_METRICS_MENU_LMPVP_TOOLTIP = "Swiches to light mode in Cyrodil. When in light mode, Combat Metrics will only calculate the DPS/HPS in the live report window. No statistics will be calculated and the big report window will be disabled",
	...
	SI_COMBAT_METRICS_MENU_AS_TOOLTIP = "Automatically take a Screenshot when opening the Report window",
	...
	SI_COMBAT_METRICS_MENU_SF_TOOLTIP = "Adjusts the size of all elements of the Fightreport Window",
