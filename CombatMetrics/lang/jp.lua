...
SafeAddString(SI_COMBAT_METRICS_DAMAGE_DONE, "与えたダメージ", 1)
...
SafeAddString(
	...
	"ストレージファイルが一杯です。容量確保のため戦闘を削除してください！",
	1
)
...
SafeAddString(
	...
	"軽量モード時は、combat metricsはライブレポートウィンドウでDPSとHPSのみ計測します。統計は出力されず大きなレポートウィンドウは無効になります。",
	1
)
...
SafeAddString(
	...
	"シロディールで軽量モードに切り替えます。軽量モード時は、combat metricsはライブレポートウィンドウでDPSとHPSのみ計測します。統計は出力されず大きなレポートウィンドウは無効になります。",
	1
)
...
SafeAddString(
	SI_BINDING_NAME_CMX_POST_DPS_SINGLE,
	"チャットに単一ターゲットのダメージを投稿する",
	1
)
SafeAddString(
	SI_BINDING_NAME_CMX_POST_DPS_MULTI,
	"チャットに複数のターゲットのダメージを投稿する",
	1
)
SafeAddString(
	SI_BINDING_NAME_CMX_POST_DPS,
	"チャットに単一＋複数のターゲットのダメージを投稿する",
	1
)
