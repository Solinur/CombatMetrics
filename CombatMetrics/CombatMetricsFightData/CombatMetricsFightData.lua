...
local logTypeToLayout = {
	[LIBCOMBAT_LOG_EVENT_DAMAGE] = LAYOUT_COMBAT,
	[LIBCOMBAT_LOG_EVENT_HEAL] = LAYOUT_COMBAT,
	[LIBCOMBAT_LOG_EVENT_EFFECT] = LAYOUT_EVENT,
	[LIBCOMBAT_LOG_EVENT_STATS] = LAYOUT_STATS,
	[LIBCOMBAT_LOG_EVENT_RESOURCE] = LAYOUT_POWER,
	[LIBCOMBAT_LOG_EVENT_COMBATSTATE] = LAYOUT_MESSAGE,
	[LIBCOMBAT_LOG_EVENT_DEATH] = LAYOUT_DEATH,
	[LIBCOMBAT_LOG_EVENT_SKILL_CAST] = LAYOUT_SKILL,
	[LIBCOMBAT_LOG_EVENT_PERFORMANCE] = LAYOUT_PERFORMANCE,
	[LIBCOMBAT_LOG_EVENT_QUICKSLOT] = LAYOUT_QUICKSLOT,
