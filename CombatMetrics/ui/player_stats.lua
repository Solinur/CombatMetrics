...
function PlayerStatsPanel:Update(fightData)
	...
	local magickacontrol = self:GetNamedChild("ResourceMagicka")
	...
	local staminacontrol = self:GetNamedChild("ResourceStamina")
	...
	local ultimatecontrol = self:GetNamedChild("ResourceUltimate")
	...
	local statWindowControl = self:GetNamedChild("AttackStats")
