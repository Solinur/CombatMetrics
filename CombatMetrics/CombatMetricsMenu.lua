...
function CMX.MakeMenu(svdefaults)
	...
	local options = {
		...
		},
		{
			...
			disabled = function()
				return (db.offincyrodil or db.lightmode)
			end,
		},
		{
			type = "checkbox",
			...
			getFunc = function()
				return db.autoselectchatchannel
			end,
			setFunc = function(value)
		...
		},
		{
			...
			step = 1,
			disabled = function()
				return not db.autoscreenshot
			end,
			default = def.autoscreenshotmintime,
			getFunc = function()
				return db.autoscreenshotmintime
			end,
			setFunc = function(value)
		...
		},
		{
			...
			getFunc = function()
				return db.FightReport.scale * 100
			end,
			setFunc = function(value)
		...
		},
		{
			...
			getFunc = function()
				return db.FightReport.useDisplayNames
			end,
			setFunc = function(value)
		...
		},
		{
			...
			getFunc = function()
				return db.FightReport.showPets
			end,
			setFunc = function(value)
		...
		},
		{
			...
			disabled = function()
				return not db.liveReport.enabled
			end,
		},
		{
			type = "slider",
			...
			getFunc = function()
				return db.liveReport.scale * 100
			end,
			setFunc = function(value)
		...
		},
		{
			...
			getFunc = function()
				return db.liveReport.alignmentleft
			end,
			setFunc = function(value)
		...
		},
		{
			...
			getFunc = function()
				return db.liveReport.damageOut
			end,
			setFunc = function(value)
		...
		},
		{
			...
			getFunc = function()
				return db.liveReport.damageOutSingle
			end,
			setFunc = function(value)
		...
		},
		{
			...
			getFunc = function()
				return db.liveReport.healOutAbsolute
			end,
			setFunc = function(value)
		...
		},
		{
			...
			getFunc = function()
				return db.chatLog.name
			end,
			setFunc = function(value)
				if value then
					CMX.ChangeCombatLogLabel(value)
				end
				db.chatLog.name = value
			end,
			disabled = function()
				return not db.chatLog.enabled
			end,
		},
		{
			type = "checkbox",
	...
	if GetDisplayName() == "@Solinur" then
		...
		options[#options + 1] = {
			...
			getFunc = function()
				return db.ForceNotification
			end,
			setFunc = function(value)
				db.ForceNotification = value
			end,
		}
	end
